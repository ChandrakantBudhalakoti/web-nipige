export default function HowItWorks() {
  ...
  return (
    <section className="section-padding bg-base-200" aria-label="How it works section">
      <div className="container-max">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="order-2 md:order-1">
            <figure className="rounded-lg overflow-hidden shadow-lg">
              <img
                ...
                alt="How it works - SaaS platform overview showing business process management"
          ...
          <div className="order-1 md:order-2 space-y-6">
              ...
              {steps.map((step, index) => (
                <li key={index} className="flex gap-4">
                  ...
                  <div className="flex-1 pt-1">
                    <h3 className="font-bold text-neutral mb-2">{step.title}</h3>
            ...
            <button className="btn btn-primary btn-lg rounded-full mt-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
              View More Solutions
            </button>
          </div>
        </div>
